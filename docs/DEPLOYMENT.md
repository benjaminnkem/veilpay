...
6. Read `apps/contracts/ignition/deployments/chain-11155111/deployed_addresses.json`. Set `CONFIDENTIAL_PAYROLL_ADDRESS` to `VeilPayPayrollModule#ConfidentialPayrollV3` and `CONFIDENTIAL_TOKEN_ADDRESS` to `VeilPayPayrollModule#TestConfidentialUSDC`. Restart the API.
